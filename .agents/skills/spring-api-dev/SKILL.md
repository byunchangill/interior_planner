...
**버전 (M0에서 확정)**: Spring Boot **4.1.0** / Java 21 / Gradle 9.5. 주의 — Boot 4는 Jackson 3(`tools.jackson`, java.time 기본 ISO-8601 직렬화), Spring Security 7, starter 명칭 변경(`spring-boot-starter-webmvc`, `spring-boot-h2console`)이 3.x와 다르다. 3.x 기준 예제 코드를 그대로 복사하지 말 것.
