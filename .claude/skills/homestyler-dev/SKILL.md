...
| 영역 | 선택 | 비고 |
|------|------|------|
| 백엔드 | Spring Boot 3.x, Java 17, Gradle | `backend/` |
| 프론트엔드 | React 18 + Vite + TypeScript + Tailwind | `frontend/` |
...
- 각 에이전트 정의: `.claude/agents/{backend-dev,frontend-dev,qa-integrator}.md`
